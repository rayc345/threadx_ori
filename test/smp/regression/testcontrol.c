...
TX_THREAD   *thread_ptr;
    ...
    _tx_thread_current_ptr[0] =  &init_test_thread;
    temp = _tx_thread_system_state[0];
    _tx_thread_system_state[0] =  0;
	...
	/* Pickup the current core exclusion.  */
	tx_thread_smp_core_exclude_get(&test_thread, &temp);
    ...
    _tx_thread_smp_core_interrupt(&test_thread, 0, 3);
    _tx_thread_current_ptr[3] =  temp_thread;
    temp_thread =  _tx_thread_execute_ptr[0];
    _tx_thread_execute_ptr[0] =  TX_NULL;
    _tx_thread_smp_lowest_priority_get();
    _tx_thread_execute_ptr[0] =  temp_thread;
    ...
    /* Test time-slice paths.  */
    _tx_timer_time_slice[0] =  0;
    _tx_timer_time_slice[1] =  1;
    _tx_timer_time_slice[2] =  0;
    _tx_timer_time_slice[3] =  0;
    _tx_thread_time_slice();

    _tx_timer_time_slice[0] =  0;
    _tx_timer_time_slice[1] =  0;
    _tx_timer_time_slice[2] =  1;
    _tx_timer_time_slice[3] =  0;
    _tx_thread_time_slice();
    ...
    _tx_timer_time_slice[2] =  0;
    _tx_timer_time_slice[3] =  0;
    temp_thread -> tx_thread_state =  TX_COMPLETED;
    _tx_thread_current_ptr[0] =  temp_thread;
    _tx_thread_time_slice();
    temp_thread -> tx_thread_state =  TX_READY;
    _tx_thread_current_ptr[0] =  TX_NULL;
    ...
    _tx_timer_time_slice[2] =  0;
    _tx_timer_time_slice[3] =  0;
    temp_thread -> tx_thread_time_slice =  0;
    _tx_thread_current_ptr[0] =  temp_thread;
    _tx_thread_time_slice();
    _tx_thread_current_ptr[0] =  TX_NULL;
