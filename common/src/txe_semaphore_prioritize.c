...
UINT    status;
    ...
    TRACE_RECORD_U32(TRACE_API_TXE_SEMAPHORE_PRIORITIZE, TX_POINTER_TO_ULONG_CONVERT(semaphore_ptr));
    ...
    TRACE_RECORD_END_CALL_U32(TRACE_API_TXE_SEMAPHORE_PRIORITIZE, status);
