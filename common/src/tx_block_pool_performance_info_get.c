...
UINT                    status;
    ...
    TRACE_RECORD_U32(TRACE_API_TX_BLOCK_POOL_PERFORMANCE_INFO_GET, TX_POINTER_TO_ULONG_CONVERT(pool_ptr));
...
UINT                    status;
    ...
    TRACE_RECORD_END_CALL_U32(TRACE_API_TX_BLOCK_POOL_PERFORMANCE_INFO_GET, status);
