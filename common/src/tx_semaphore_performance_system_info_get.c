...
TX_INTERRUPT_SAVE_AREA
    ...
    TRACE_RECORD_VOID(TRACE_API_TX_SEMAPHORE_PERFORMANCE_SYSTEM_INFO_GET);
    ...
    TRACE_RECORD_END_CALL_U32(TRACE_API_TX_SEMAPHORE_PERFORMANCE_SYSTEM_INFO_GET, TX_SUCCESS);
...
UINT        status;
    ...
    TRACE_RECORD_END_CALL_U32(TRACE_API_TX_SEMAPHORE_PERFORMANCE_SYSTEM_INFO_GET, status);
