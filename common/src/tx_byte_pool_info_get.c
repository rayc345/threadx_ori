...
TX_INTERRUPT_SAVE_AREA
    ...
    TRACE_RECORD_U32(TRACE_API_TX_BYTE_POOL_INFO_GET, TX_POINTER_TO_ULONG_CONVERT(pool_ptr));
    ...
    TRACE_RECORD_END_CALL_U32(TRACE_API_TX_BYTE_POOL_INFO_GET, TX_SUCCESS);
